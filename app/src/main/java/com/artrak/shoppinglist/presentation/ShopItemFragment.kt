...
class ShopItemFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // получаем все данные из интента
        viewModel = ViewModelProvider(this)[ShopItemViewModel::class.java]
        initViews(view)                                     // инициализируем все View-элементы
        addTextChangeListeners()                        // добавляем слушатели ввода текста
        launchRightMode()                               // запуск правильного режима экрана
        observeViewModel()                              // подписываемся на все обьекты ViewModel
    }
    ...
    private fun parseParams() {
        ...
        if (mode != MODE_EDIT && mode != MODE_ADD) {
            throw RuntimeException("Unknown screen mode is absent")
        }
        screenMode = mode
    ...
    companion object {
        ...
        private const val MODE_UNKNOWN = "extra_add"
